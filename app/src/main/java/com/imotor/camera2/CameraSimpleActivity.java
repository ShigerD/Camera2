...
/**
 * Created by Shiger on 3/6/18.
 * e-mail : tigerwithwings@foxmail.com
 */

public class CameraSimpleActivity extends Activity implements TextureView.SurfaceTextureListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_camera2_sample);
        mThreadHandler = new HandlerThread("CAMERA2");
        mThreadHandler.start();
        mHandler = new Handler(mThreadHandler.getLooper());
        mPreviewView = (TextureView) findViewById(R.id.texture);
    ...
    public void onSurfaceTextureAvailable(SurfaceTexture surface, int width, int height) {
        ...
        try {
            ...
            Log.d(TAG, "CameraIdList:" + CameraIdList.length);
            //获取可用相机设备列表
